 ...
 * Plugin URI:  https://briangarder.com/
...
// Exclude noindex from sitemap.
add_filter( 'wp_sitemaps_posts_query_args', 'simple_seo_exclude_noindex', 10, 2 );
function simple_seo_exclude_noindex( $args, $post_type ) {
